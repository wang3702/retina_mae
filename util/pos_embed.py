...
def interpolate_pos_embed(model, checkpoint_model):
    if 'pos_embed' in checkpoint_model:
        ...
        new_size1 = new_size1//model.patch_embed.patch_size[0]
        new_size2 = new_size2//model.patch_embed.patch_size[1]
        ...
        if orig_size != new_size1 or orig_size!=new_size2:
            ...
            pos_tokens = torch.nn.functional.interpolate(
                pos_tokens, size=(new_size1, new_size2), mode='bicubic', align_corners=False)
